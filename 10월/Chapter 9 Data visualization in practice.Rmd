...
22,23,24,…  or  102,103,…  are easy to compute in our heads,the same is not true for  e2,e3,… , so the scale is not intuitive or easy to interpret.
...
The logistic or logit transformation for a proportion or rate  pis defined as: f(p)=log(p/1−p)
