...
files
```
according to the problem, i need to open files no. 2,3,5,6,7,9. But as an exercise i opened it all.
...
dir <- system.file("extdata", package = "dslabs") 
fullpath <- file.path(dir, filename)
file.copy(fullpath, "2010_bigfive_regents.xls")

no.1 <- read_excel("2010_bigfive_regents.xls")
no.1
```
...
dir <- system.file("extdata", package = "dslabs") 
fullpath <- file.path(dir, filename)
file.copy(fullpath, "carbon_emissions.csv")

no.2 <- read.csv("carbon_emissions.csv")
no.2
```
...
dir <- system.file("extdata", package = "dslabs") 
fullpath <- file.path(dir, filename)
file.copy(fullpath, "fertility-two-countries-example.csv")

no.3 <- read.csv("fertility-two-countries-example.csv")
no.3
```
...
dir <- system.file("extdata", package = "dslabs") 
fullpath <- file.path(dir, filename)
file.copy(fullpath, "HRlist2.txt")

no.4 <- read.table("HRlist2.txt")
no.4
```
...
dir <- system.file("extdata", package = "dslabs") 
fullpath <- file.path(dir, filename)
file.copy(fullpath, "life-expectancy-and-fertility-two-countries-example.csv")

no.5 <- read.csv("life-expectancy-and-fertility-two-countries-example.csv")
no.5
```
...
dir <- system.file("extdata", package = "dslabs") 
fullpath <- file.path(dir, filename)
file.copy(fullpath, "RD-Mortality-Report_2015-18-180531.pdf")
library(pdftools)
no.8 <- pdf_text("RD-Mortality-Report_2015-18-180531.pdf")
no.8
```
...
dir <- system.file("extdata", package = "dslabs") 
fullpath <- file.path(dir, filename)
file.copy(fullpath, "ssa-death-probability.csv")

no.9 <- read.csv("ssa-death-probability.csv")
no.9
```
