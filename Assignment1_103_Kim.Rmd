...
3. Select the gene we want to see.
4. Visualize geom_point
5. Combine plots
...
Load "Tumor purity table". Both tumor tissue and normal tissue of patients' tumor purity is calculated. So I removed normal tissue to avoid overlapping patient code.
```{r}
...
New median values are defined by extracting patients divided into groups.
